...
@section('content')
				...
				<div class="row row-sm">
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12"  style=" box-shadow: none !important; ">
						<div class="card overflow-hidden sales-card bg-primary-gradient" style=" box-shadow: none !important; ">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">{{trans('main_trans.TOTAL NUMBER OF INVOICES')}}</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">{{$count2}}</p>
										</div>
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12" style=" box-shadow: none !important; ">
						<div class="card overflow-hidden sales-card bg-danger-gradient"  style=" box-shadow: none !important; ">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0" style=" box-shadow: none !important; ">
								<div class="">
                                    <h6 class="mb-3 tx-12 text-white">{{ trans('main_trans.TOTAL NUMBER OF UNPAID INVOICES') }}</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{$unpagid_count1}}</h4>
											<p class="mb-0 tx-12 text-white op-7">{{$count_unpaid}}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">{{$percentage.'%'}}</span>
										</span>
									</div>
								</div>
							</div>
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-success-gradient"  style=" box-shadow: none !important; ">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0"  style=" box-shadow: none !important; ">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">{{trans('main_trans.TOTAL NUMBER OF PAID INVOICES')}}</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{$paid_sum}}</h4>
											<p class="mb-0 tx-12 text-white op-7">{{$count_paid}}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7">{{$percentage_paid.'%'}}</span>
										</span>
									</div>
								</div>
							</div>
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-warning-gradient" style=" box-shadow: none !important; ">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0"  style=" box-shadow: none !important; ">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">{{trans('main_trans.TOTAL NUMBER OF PARTILLY PAID INVOICES')}}</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{$partilly_sum}}</h4>
											<p class="mb-0 tx-12 text-white op-7">{{$count_paidilly}}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">{{$percentage_partilly.'%'}}</span>
										</span>
									</div>
								</div>
							</div>
				...
				<!-- row opened -->
				<div class="row row-sm">
					<div class="col-md-12 col-lg-12 col-xl-7"  style=" box-shadow: none !important; ">
						<div class="card"  style=" box-shadow: none !important; ">
							<div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0"  style=" box-shadow: none !important; ">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mb-0">{{trans('main_trans.bar')}}</h4>
					...
					<div class="col-lg-12 col-xl-5"  style=" box-shadow: none !important; ">
						<div class="card card-dashboard-map-one" style=" box-shadow: none !important; ">
							<label class="main-content-label">{{trans('main_trans.bar')}}</label>
...
//    var pusher = new Pusher('bd15845ce6b4e88234f3', {
//     cluster: 'mt1'
// });
...
window.Echo.channel('new-notification')
    .listen('notification', (event) => {
        ...
        // اتخاذ أي إجراءات إضافية هنا
    });
</script> --}}

{{-- <script src="{{ asset('pusherNotifications2.js') }}"></script> --}}
<script>
    console.log('468');
