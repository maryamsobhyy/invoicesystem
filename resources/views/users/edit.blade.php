    ...
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{trans('main_trans.Users')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                {{trans('main_trans.Edit user')}}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="">
                    ...
                    <div class="row mg-b-20">
                        <div class="parsley-input col-md-6" id="fnWrapper">
                            <label>{{trans('main_trans.User name')}} : <span class="tx-danger">*</span></label>
                ...
                <div class="row mg-b-20">
                    ...
                    <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                        <label> {{trans('main_trans.confirmpassword')}}  : <span class="tx-danger">*</span></label>
                ...
                <div class="row mg-b-20">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>{{trans('main_trans.Type Of User')}} </strong>
                ...
                <div class="mg-t-30">
                    <button class="btn btn-main-primary pd-x-20" type="submit">{{trans('main_trans.save')}}</button>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
