<!-- main-header opened -->
			<div class="main-header sticky side-header nav nav-item" style="background-color: rgb(14, 68, 84);box-shadow: none;color: black ">
					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
                            ...
                            <div class="dropdown nav-item main-header-notification">
								<a class="new nav-link" href="#" data-toggle="dropdwon">
								<svg xmlns="http://www.w3.org/2000/svg" class="header-icon-svgs" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bell"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg><span class=" pulse"></span></a>
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											<h6 class="dropdown-title mb-1 tx-15 text-white font-weight-semibold">{{ trans('main_trans.notification') }}</h6>
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="{{route('mark')}}">{{ trans('main_trans.mark') }}</a></span>
										</div>
                            ...
                            {{-- <div class="dropdown nav-item main-header-notification">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											<h6 class="dropdown-title mb-1 tx-15 text-white font-weight-semibold">{{ trans('main_trans.notification') }}</h6>
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left">{{ trans('main_trans.mark') }}</span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12  data-count">{{ trans('main_trans.youhave') }} {{ auth()->user()->unreadNotifications->count() }}
                                            {{ trans('main_trans.unread') }}  </p>
									</div>
                                    @foreach (auth()->user()->unreadNotifications as $notification)
                                    <div class="main-notification-list Notification-scroll">
                                        <a class="d-flex p-3 border-bottom"
                                            href="{{ route('invoice.details', $notification->data['id'])}}">
                                            <div class="notifyimg bg-pink">
                                                <i class="la la-file-alt text-white"></i>
                                            </div>
                                            <div class="mr-3">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('Attachments/th.jpg')}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											{{-- <div class="main-img-user"><img alt="" src="{{URL::asset('Attachments/th.jpg')}}" class=""></div> --}}
